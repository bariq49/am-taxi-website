            ...
            <div className="container mx-auto px-4">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center`}>
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        {title && <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-3">
                            {title}
                        </h2>}
                        {description && <div className="text-sm md:text-base text-gray-500 leading-relaxed mb-2">
                            {description}
                        </div>}
                        {points && points.length > 0 && (
                            <div className="mb-10 w-full">
                                {pointsTitle && (
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4 mt-2">
                                        {pointsTitle}
                                    </h4>
                                )}
                                ...
                                {pointsDescription && <div className="text-sm md:text-base text-gray-500 leading-relaxed mb-2 mt-4">
                                    {pointsDescription}
                                </div>}
                            </div>
                        )}
